...
impl MitoAgent {
    ...
    async fn run_agent(mut config: AgentConfig) -> crate::error::Result<()> {
        ...
        // TODO: we might have to store the machine_code in our local path like how we store
        // credentials, in case the machine_code is manually generated by us when the system's
