            ...
            TaskState::Cancelled => match result {
                Some(result_spec) => match result_spec.msg {
                    Some(msg) => matrix_match!(
                        (target_state, msg); TaskResultMessage::FetchResourceTimeout, TaskResultMessage::ExecTimeout, TaskResultMessage::UploadResultTimeout, TaskResultMessage::ResourceNotFound, TaskResultMessage::ResourceForbidden, TaskResultMessage::WatchTimeout =>
                        TaskExecState::WorkerExited             => false, false, false, false, false, false;
                        TaskExecState::FetchResource            => false, false, false, false, false, false;
                        TaskExecState::FetchResourceFinished    => false, false, false, false, false, false;
                        TaskExecState::FetchResourceError       => false, false, false, false, false, false;
                        TaskExecState::FetchResourceTimeout     => true,  false, false, false, false, false;
                        TaskExecState::FetchResourceNotFound    => false, false, false, true,  false, false;
                        TaskExecState::FetchResourceForbidden   => false, false, false, false, true,  false;
                        TaskExecState::Watch                    => false, false, false, false, false, false;
                        TaskExecState::WatchFinished            => false, false, false, false, false, false;
                        TaskExecState::WatchTimeout             => false, false, false, false, false, true;
                        TaskExecState::ExecPending              => false, false, false, false, false, false;
                        TaskExecState::ExecSpawned              => false, false, false, false, false, false;
                        TaskExecState::ExecFinished             => false, false, false, false, false, false;
                        TaskExecState::ExecTimeout              => false, true,  false, false, false, false;
                        TaskExecState::UploadResult             => true,  true,  true,  true,  true,  true;
                        TaskExecState::UploadFinishedResult     => false, false, false, false, false, false;
                        TaskExecState::UploadCancelledResult    => true,  true,  true,  true,  true,  true;
                        TaskExecState::UploadResultFinished     => true,  true,  true,  true,  true,  true;
                        TaskExecState::UploadResultTimeout      => false, false, true,  false, false, false;
                        TaskExecState::TaskCommitted            => true,  true,  true,  true,  true,  true;
                        TaskExecState::Unknown                  => false, false, false, false, false, false;
                    ),
                    None => false,
                },
                None => false,
